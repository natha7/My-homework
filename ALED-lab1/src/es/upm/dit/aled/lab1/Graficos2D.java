 ...
 */
public final class Graficos2D implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static Graficos2D std = null;
    ...
    public Graficos2D(int xl,int yl) { 
    		setLocation(xl,yl);
    		if (std == null)
    			std=this;
    		init(); 
